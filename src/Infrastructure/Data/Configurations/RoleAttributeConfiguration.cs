...
{
    public class RoleAttributeConfiguration : IEntityTypeConfiguration<RoleAttribute>
    {
        public void Configure(EntityTypeBuilder<RoleAttribute> builder)
        {
            builder.ToTable("RoleAttributes");
            ...
            builder.Property(_ => _.RoleId).HasMaxLength(100);
            builder.HasIndex(_ => new { _.RoleId, _.Type }).IsUnique(true);
        }
    }
}
