        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepeatInMinute = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BgScheduleId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAttributes_ExternalId",
                table: "UserAttributes",
                column: "ExternalId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAttributes_UserId_Type",
                table: "UserAttributes",
                columns: new[] { "UserId", "Type" },
                unique: true,
                filter: "[UserId] IS NOT NULL AND [Type] IS NOT NULL");
        }
